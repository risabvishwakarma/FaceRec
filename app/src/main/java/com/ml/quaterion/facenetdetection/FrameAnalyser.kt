...
class FrameAnalyser( context: Context ,
    ...
    //        imageCapBut=(Button) findViewById(R.id.image_capture_button);
//        videocap=(Button) findViewById(R.id.video_capture_button);
    ...
    // <-------------------------------------------------------->
   // previewView1 = findViewById<android.view.View?>(R.id.preview_view) as PreviewView?
